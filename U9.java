...
// the total amount that a person will receive after the end of 5 years ofr a deposit of Rs. 5000
...
class calamount
{
    ...
    void callint()
    {
        ...
        System.out.println("Interest is=> "+ci+" & amount Recevied is=> "+netvalue);
    }
}
